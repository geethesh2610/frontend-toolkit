...
export const TOOLKIT: ToolkitSection[] = [
    ...
    {
        folder: "state/",
        blurb: "Not import-as-is — copy the whole folder for the approach you want, then rename the domain.",
        items: [
            {
                name: "context/",
                use: "Small-to-medium app, no extra dependency wanted — Context + useReducer, split so action-only consumers don't re-render.",
                files: [
                    ...
                    "/src/state/context/TodoList.tsx",
                    "/src/state/context/TodoList.style.tsx",
                    "/src/state/todo.types.ts",
                ],
            },
            {
                name: "zustand/",
                use: "Want a store without wrapping the app in a provider — a module-level hook.",
                files: ["/src/state/zustand/useTodoStore.ts", "/src/state/zustand/TodoList.tsx", "/src/state/zustand/TodoList.style.tsx", "/src/state/todo.types.ts"],
            },
            {
                name: "redux/",
                use: "Already-Redux codebase, or want devtools/middleware/time-travel debugging out of the box.",
                files: [
                    "/src/state/redux/store.ts",
                    "/src/state/redux/todosSlice.ts",
                    "/src/state/redux/todosSelectors.ts",
                    "/src/state/redux/hooks.ts",
                    "/src/state/redux/TodoList.tsx",
                    "/src/state/redux/TodoList.style.tsx",
                    "/src/state/todo.types.ts",
                ],
            },
            {
                name: "mobx/",
                use: "Prefer mutating observable state directly over reducers/actions.",
                files: [
                    ...
                    "/src/state/mobx/TodoList.tsx",
                    "/src/state/mobx/TodoList.style.tsx",
                    "/src/state/todo.types.ts",
                ],
            },
        ],
